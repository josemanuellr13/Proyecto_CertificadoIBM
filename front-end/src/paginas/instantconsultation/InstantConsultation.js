            ...
            <div className='max-w-screen-2xl mx-auto flex overflow-hidden  w-full'>
                ...
                <div className='w-2/3 flex flex-col gap-3 justify-center h-80'>
                    <div className='flex flex-col items-start'>
                        <h1 className='text-ppala text-left text-4xl xl:text-6xl font-bold'>Medical emergency?</h1>
                        <div className='flex'>
                            <p className=' text-4xl xl:text-4xl font-extrabold p-1 text-slate-500'>Immediate care</p>
                        <div className='bg-[#D3F2EB] inline-block left-0'>
                            <h1 className='text-gradient text-4xl xl:text-4xl font-extrabold bg-[#D3F2EB] text-left '>is crucial</h1>
                        </div>
                        </div>
                        
                    </div>

                    <p className='text-left text-slate-600 text-sm'>Our team of dedicated doctors is available right now to address your urgent medical needs. </p>
                ...
                <div className='w-1/3 h-80'>
                    <img src={assetPath + "figure3.png"} className='h-80 object-contain w-full'></img>
                </div>
            </div>
          </div>
