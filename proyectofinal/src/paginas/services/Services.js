...
import iconNow from '../../assets/imgs/icon-now.png'
import iconCalendar from '../../assets/imgs/icon-calendar.png'
import iconPerson from '../../assets/imgs/icon-person.png'
import iconLight from '../../assets/imgs/icon-light.png'
...
function Services() {
    return (
      <div className='flex flex-col grow w-full max-w-screen-2xl mx-auto items-center justify-center gap-5'>
         <h2 className='text-6xl text-center font-semibold mt-10'>Full range of <div className='bg-[#D3F2EB] '>
        ...
        <div className='flex xw-min flex-row bg-white rounded-sm border border-slate-200 grow-0 shadow-lg'>
            <Link className='flex-1 flex flex-col justify-center p-8 border-r hover:bg-ppala group'>
                <img src={iconNow} className='w-10 mb-2'></img>
            ...
            <Link className='flex-1 flex flex-col justify-center p-8 border-r hover:bg-ppala group'>
                <img src={iconCalendar} className='w-10 mb-2'></img>
            ...
            <Link className='flex-1 flex flex-col justify-center p-8 border-r hover:bg-ppala group'>
                <img src={iconPerson} className='w-10 mb-2'></img>
            ...
            <Link className='flex-1 flex flex-col justify-center p-8 border-r hover:bg-ppala group'>
                <img src={iconLight} className='w-10 mb-2'></img>
