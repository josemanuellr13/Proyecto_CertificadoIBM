          ...
          await axios
            ...
            .then((res) => {
              ...
              if(res.status === 404){
                ...
                setMensajeExito("User created successfully.")
          ...
          <div className='w-1/2 flex items-center justify-center p-5'> 
           <form onSubmit={(e) => onSubmit(e)} className='bg-white rounded-md lg:w-2/3 flex flex-col gap-3 p-10 border border-slate-200'>
                <div>
                    ...
                    <p className='text-left text-slate-500'>Welcome to our platform. Already a member? <a  href="/register" className='text-blue-600'>Log in</a></p>
                </div>
                ...
                <div>
                    ...
                    <input className='bg-[#F9FAFF] border border-[#E0E6F6] w-full rounded-sm text-sm p-3' type="password" name="contraseña" value={userData.contraseña} onChange={handleInputChange} placeholder='Type your password'/>
                </div>

                <div>
                    <p className='text-left text-sm text-slate-500 pb-1'>Repeat your password</p>
                    <input className='bg-[#F9FAFF] border border-[#E0E6F6] w-full rounded-sm text-sm p-3' type="password"  placeholder='Repeat your password'/>
                </div>
